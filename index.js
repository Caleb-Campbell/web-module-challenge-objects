...
*/
console.log(createMenuItem('Finish and Chips', 12, 'Dinner'))
console.log(createMenuItem('Grilled Cheese', 6, 'Lunch'))
console.log(createMenuItem('Protein Shake', 5, 'Breakfast'))
...
const burger = {
  ...
  price: 18, 
  category: "Lunch", 
  discount: function discountRate(person){
...
function getReviewByIndex(array,indWanted) {
  
  return `${array[indWanted].name} gave the restaurant a ${array[indWanted].rating} star review, and their feedback was: ${array[indWanted].feedback}`
  }
